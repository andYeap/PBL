...
import 'package:admin_pegawai/providers/pengguna_pegawai_provider.dart';
import 'package:admin_pegawai/providers/pengguna_dosen_provider.dart';
...
import 'package:admin_pegawai/screens/khs_screen.dart';
import 'package:admin_pegawai/screens/pengguna_screen.dart';
import 'package:admin_pegawai/screens/pengguna_pegawai_screen.dart';
import 'package:admin_pegawai/screens/pengguna_dosen_screen.dart'; // TAMBAHKAN: Screen Dosen Baru
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // ChangeNotifierProvider(create: (_) => PenggunaPegawaiProvider()),
        ChangeNotifierProvider(
          create: (_) =>
              PenggunaDosenProvider(), // TAMBAHKAN: Inisialisasi Provider Dosen
        ),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // --- ROUTE UTAMA PENGGUNA, PEGAWAI, DAN DOSEN ---
        "/pengguna": (context) => const PenggunaScreen(),
        // "/pengguna-pegawai": (context) => const PenggunaPegawaiScreen(),
        "/pengguna-dosen": (context) =>
            const PenggunaDosenScreen(), // TAMBAHKAN: Route Dosen
        // --- ROUTE AKADEMIK ---
